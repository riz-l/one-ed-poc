...
- To start using this app, open your chosen Text Editor, navigate to your specified folder directory, open a new Terminal and run:
  ...
  ```
  $ git clone https://github.com/riz-l/one-ed-poc.git
  ```

- After this, make sure you `cd` into the newly cloned folder directory e.g. `cd one-ed-poc`, and then run:
